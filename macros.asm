...
convertAscii macro num,buffer
    ...
    getDigits:     
                   ...
                   mov   buffer[si],ah
endm
;------- macro de ingreso de coeficientes
;macro para obtener los coeficientes
getCoefficients macro
                    LOCAL      while,coefficient5,coefficient4,coefficient3,coefficient2,coefficient1,coefficient0, finish
                    print      newLine
                    xor        cx, cx
                    mov        cx, 5
                    mov        bl, 54
    ...
    coefficient5:   
                    getTexto   coeficiente5
                    dec        cx
                    checkInput coeficiente5
                    jmp        while
    coefficient4:   
                    getTexto   coeficiente4
                    dec        cx
                    checkInput coeficiente4
                    jmp        while
    coefficient3:   
                    getTexto   coeficiente3
                    dec        cx
                    checkInput coeficiente3
                    jmp        while
    coefficient2:   
                    getTexto   coeficiente2
                    dec        cx
                    checkInput coeficiente2
                    jmp        while
    coefficient1:   
                    getTexto   coeficiente1
                    dec        cx
                    checkInput coeficiente1
                    jmp        while
    coefficient0:   
                    getTexto   coeficiente0
                    checkInput coeficiente0
    finish:         
                    print      newLine
endm
